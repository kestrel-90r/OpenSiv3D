...
namespace s3d
{
    ...
    private:
        ...
        static void CursorDeleter(void *h)
        {
        }

        std::array<void *, 11> m_systemCursors;
        void *m_currentCursor = nullptr;
        void *m_defaultCursor = nullptr;
        void *m_requestedCursor = nullptr;
        HashTable<String, unique_resource<void *, decltype(&CursorDeleter)>> m_customCursors;
