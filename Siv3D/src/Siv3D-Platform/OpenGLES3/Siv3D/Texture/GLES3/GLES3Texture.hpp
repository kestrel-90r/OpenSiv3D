...
namespace s3d
{
	...
	public:
		...
		GLES3Texture(Render, const Size& size, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);

		GLES3Texture(Render, const Image& image, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);

		GLES3Texture(Render, const Grid<float>& image, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);

		GLES3Texture(Render, const Grid<Float2>& image, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);

		GLES3Texture(Render, const Grid<Float4>& image, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);

		GLES3Texture(MSRender, const Size& size, const TextureFormat& format, TextureDesc desc, HasDepth hasDepth);
